...
import Filters, { ShopFiltersState } from ".";
...
const MobileFilters = ({ filters, onChange, onReset }: MobileFiltersProps) => {
  const { t } = useLanguage();
      ...
      <Drawer>
        ...
        <DrawerContent className="max-h-[90%]">
          <DrawerHeader>
            ...
            <DrawerTitle className="hidden">{t("filters")}</DrawerTitle>
            <DrawerDescription className="hidden">{t("filters")}</DrawerDescription>
          </DrawerHeader>
